...
export default function SearchScreen({navigation}) {
        ...
        <View style={{marginVertical: 7}}>
          <TouchableOpacity
            ...
            <View style={{width: '50%'}}>
              ...
              <Text style={styles.profession}>
                In Time:-
                {source.clinics[source.clinic_index].timing.intime - 12 < 0
                  ? source.clinics[source.clinic_index].timing.intime + ' am'
                  : source.clinics[source.clinic_index].timing.intime -
                    12 +
                    ' pm'}
              </Text>
              <Text style={styles.profession}>
                Out Time:-
                {source.clinics[source.clinic_index].timing.outime - 12 < 0
                  ? source.clinics[source.clinic_index].timing.outime + ' am'
                  : source.clinics[source.clinic_index].timing.outime -
                    12 +
                    ' pm'}
              </Text>
            </View>
        ...
        <View style={{marginVertical: 7}}>
          <TouchableOpacity
            ...
            <View style={{width: '50%'}}>
              ...
              <Text style={[styles.profession, {opacity: 1}]}>
                Facilities:-
              </Text>
              {item.facility.map((source, index) => {
                return <Text style={styles.profession}>{source}</Text>;
              })}
  ...
  const ItemViewLabs = ({source, i}) => {
    return (
      <View style={styles.doctorlist} key={i}>
        <View style={styles.up}>
          <View>
            <Image source={links.clinic} style={styles.thumb2} />
            <View
              style={{
                height: 20,
                alignItems: 'center',
          ...
          <View
            ...
            <Text
              ...
              Report In{' '}
              <Text
                style={{fontSize: 12, fontWeight: 'bold', color: '#373737'}}>
                5 hours
              </Text>
            </Text>
          </View>
            ...
            {doctorsfilter.length > 0 ? (
              <View>
                ...
                <ScrollView
                  ...
                  style={[
                    styles.dname,
                    {height: 500, width: '90%', paddingBottom: 10},
                  ]}>
                  {/* <FlatList
                data={doctorsfilter}
                scrollEnabled={false}
            ...
            {labsfilter.length > 0 ? (
              <View>
                ...
                <ScrollView
                  ...
                  style={[
                    styles.dname,
                    {height: 750, width: '90%', paddingBottom: 10},
                  ]}>
                  {/* <FlatList
                  data={clinicsfilter}
                  scrollEnabled={false}
